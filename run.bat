rem Install ImageMagick and Ghostscript to work!
rem insert global path
rem rename to gs.exe 
convert -density 600 ./pdf/balance.pdf ./img/balance.png
convert -density 600 ./pdf/cast.pdf ./img/cast.png
convert -density 600 ./pdf/character.pdf ./img/character.png
convert -density 600 ./pdf/cutscene.pdf ./img/cutscene.png
convert -density 600 ./pdf/gameplay.pdf ./img/gameplay.png
convert -density 600 ./pdf/heros_journey.pdf ./img/heros_journey.png
...
convert -density 600 ./pdf/scene.pdf ./img/scene.png
